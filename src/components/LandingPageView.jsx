...
// (Navbar is imported from ./Navbar)
...
function HeroSection({ onOpenDemo, onOpenVideo, onExplorePlatform }) {
  ...
  const headlineLines = [
    { text: 'Every Mine.', color: 'text-offwhite', size: 'text-4xl sm:text-6xl md:text-7xl' },
    { text: 'Every Compliance.', color: 'text-offwhite', size: 'text-4xl sm:text-6xl md:text-7xl' },
    { text: 'One Intelligence.', color: 'text-amber', size: 'text-5xl sm:text-7xl md:text-8xl' },
  ];

  return (
    <section
      ref={heroRef}
      className="relative min-h-screen w-full flex flex-col justify-between pt-28 sm:pt-32 pb-0 overflow-hidden bg-coal"
    >
      ...
      <motion.div
        ...
        className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full my-auto py-8 sm:py-12"
      >
        {/* Top Left Badge */}
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-3 py-1 rounded-[8px] border border-amber/40 bg-coal/70 backdrop-blur-md text-amber text-[11px] sm:text-xs font-mono tracking-wide mb-6 sm:mb-8"
        >
          <span>🇮🇳</span>
        ...
        <motion.p
          ...
          className="text-sm sm:text-lg text-offwhite/85 max-w-[520px] font-normal leading-relaxed mb-8 sm:mb-10"
        >
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.96 }}
            className="w-full sm:w-auto px-7 py-3.5 bg-amber text-coal font-semibold text-sm rounded-[8px] tracking-wide hover:bg-amber/90 transition-colors shadow-[0_0_30px_rgba(245,166,35,0.25)] font-mono text-center justify-center flex items-center"
          >
            Explore Platform →
          </motion.button>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.96 }}
            className="w-full sm:w-auto px-7 py-3.5 border border-offwhite/30 text-offwhite font-medium text-sm rounded-[8px] tracking-wide transition-all text-center justify-center flex items-center"
          >
            Watch Demo ▶
          </motion.button>
        </motion.div>
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center gap-4 sm:gap-8 md:gap-10 text-xs sm:text-sm font-display tracking-wider text-offwhite/80"
        >
          <div>
            <span className="font-extrabold text-white text-base mr-2">321</span>
            <span>Active Mines</span>
          </div>
          <div className="w-[1px] h-4 bg-amber/50 hidden xs:block" />
          <div>
...
function CrisisSection() {
  ...
  return (
    <section
      id="crisis"
      ref={ref}
      className="py-20 sm:py-32 px-4 sm:px-6 bg-graphite dot-grid-amber relative overflow-hidden"
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-7 space-y-4 sm:space-y-6">
          <motion.div
            ...
            className="text-[11px] sm:text-xs font-mono text-amber tracking-widest uppercase font-bold"
          >
            THE PROBLEM
          </motion.div>
          ...
          <motion.h2
            ...
            className="font-display font-extrabold text-3xl sm:text-5xl lg:text-6xl text-offwhite leading-[1.08] sm:leading-[1.05] tracking-tight"
          >
            ₹4,200 Cr lost annually <br className="hidden sm:inline" />
          ...
          <motion.p
            ...
            className="text-dim text-sm sm:text-lg leading-relaxed max-w-xl font-normal"
          >
          ...
          <div className="space-y-2.5 pt-2 sm:pt-4">
            {painPoints.map((point, idx) => (
              <motion.div
                ...
                className="flex items-center text-offwhite text-xs sm:text-base font-normal"
              >
                <span className="text-red-500 font-bold font-mono text-base sm:text-lg mr-2.5 sm:mr-3">×</span>
                <span>{point}</span>
              </motion.div>
            ))}
          </div>
        ...
        <div className="lg:col-span-5 space-y-3 sm:space-y-4">
          ...
          <motion.div
            ...
            className="bg-slate border-l-[3px] border-amber rounded-xl sm:rounded-[8px] p-4 sm:p-6 shadow-lg"
          >
            <div className="font-display font-extrabold text-4xl sm:text-5xl lg:text-6xl text-amber leading-none mb-1.5 sm:mb-2">
              <AnimatedCounter value={73} suffix="%" />
            </div>
            <div className="text-xs sm:text-sm font-medium text-offwhite/90">
...
function HorizontalModulesSection() {
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden flex flex-col justify-center px-4 sm:px-8 md:px-16">
        {/* Title Pinned Above Cards */}
        <div className="max-w-7xl mx-auto w-full mb-4 sm:mb-8">
          <div className="text-[11px] sm:text-xs font-mono text-amber uppercase tracking-widest font-bold mb-1.5 sm:mb-2 flex items-center justify-between">
            <span>SYSTEM ARCHITECTURE</span>
            <span className="text-dim text-[10px] sm:hidden font-mono tracking-normal">Swipe / Scroll ↔</span>
          </div>
          <h2 className="font-display font-extrabold text-2xl sm:text-4xl md:text-5xl text-white tracking-tight">
        ...
        <div className="w-full overflow-hidden">
          <motion.div
            style={{ x }}
            className="flex w-max gap-4 sm:gap-6 pl-2 sm:pl-4 pr-16 sm:pr-32"
          >
            {modules.map((item) => (
              <motion.div
                key={item.num}
                ...
                className="w-[82vw] max-w-[340px] sm:w-[360px] md:w-[380px] h-[390px] sm:h-[450px] md:h-[480px] shrink-0 bg-graphite border border-white/[0.06] rounded-2xl sm:rounded-[8px] p-5 sm:p-7 md:p-8 flex flex-col justify-between transition-colors relative group"
              >
                {/* Card Top: Number + CSS-Drawn Icon */}
                <div>
                  <div className="flex items-start justify-between mb-5 sm:mb-8">
                    <span className="font-mono text-amber font-normal text-3xl sm:text-5xl leading-none">
                      {item.num}
                    </span>
                    
                    {/* CSS-Drawn Icon */}
                    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-[8px] bg-coal border border-amber/20 flex items-center justify-center text-amber relative overflow-hidden group-hover:border-amber/50 transition-colors">
                      {item.iconKind === 'radar' && (
...
function AIEngineSection() {
  ...
  return (
    <section
      id="ai-engine"
      ref={sectionRef}
      className="py-20 sm:py-32 px-4 sm:px-6 bg-coal dot-grid-amber relative overflow-hidden"
    >
      <div className="max-w-7xl mx-auto">
        <div className="mb-10 sm:mb-16">
          <div className="text-[11px] sm:text-xs font-mono text-amber uppercase tracking-widest font-bold mb-2">
            INTELLIGENCE CORE
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-stretch">
          ...
          <div className="lg:col-span-6 bg-[#0A0A0A] border border-amber/30 rounded-2xl sm:rounded-[8px] shadow-amber-glow p-4 sm:p-6 flex flex-col justify-between min-h-[360px] sm:min-h-[420px] font-mono text-xs sm:text-sm">
            {/* Title Bar */}
            <div>
              <div className="flex items-center justify-between pb-3 sm:pb-4 mb-3 sm:mb-4 border-b border-white/[0.08]">
                ...
                <span className="text-dim text-[10px] sm:text-xs truncate">khanijai-engine-core ~ bash - 80x24</span>
              </div>

              {/* Typewriter Output */}
              <div className="space-y-2 font-mono text-xs sm:text-sm leading-relaxed overflow-x-auto break-words">
            ...
            <div className="pt-3 mt-4 sm:pt-4 sm:mt-6 border-t border-white/[0.06] text-[10px] sm:text-xs text-dim flex flex-col sm:flex-row gap-1.5 sm:items-center sm:justify-between">
...
function DashboardSection({ onOpenDemo, onExplorePlatform }) {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-20 sm:py-32 px-4 sm:px-6 bg-graphite relative overflow-hidden"
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        {/* Left Side: Text Content */}
        <div className="lg:col-span-5 space-y-4 sm:space-y-6">
          <div className="text-[11px] sm:text-xs font-mono text-amber uppercase tracking-widest font-bold">
            COMMAND HUB
          </div>
          <h2 className="font-display font-extrabold text-3xl sm:text-5xl text-white tracking-tight leading-[1.05]">
            Your entire mine. <br className="hidden sm:inline" />
          ...
          <div className="space-y-2.5 sm:space-y-3 pt-2">
            {bullets.map((bullet, idx) => (
              <motion.div
                ...
                className="flex items-start text-offwhite/90 text-xs sm:text-base"
              >
                <span className="text-amber font-bold mr-2.5 sm:mr-3 mt-0.5">✓</span>
                <span>{bullet}</span>
              </motion.div>
            ))}
          </div>

          <div className="pt-3 sm:pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
            <motion.button
              onClick={onExplorePlatform}
              whileHover={{ scale: 1.04 }}
              whileTap={{ scale: 0.96 }}
              className="w-full sm:w-auto px-6 py-3 bg-amber text-coal font-semibold text-sm rounded-[8px] tracking-wide hover:bg-amber/90 transition-colors shadow-amber-glow font-mono text-center justify-center flex items-center"
            >
              See Live Dashboard →
            </motion.button>
            <motion.button
              ...
              whileHover={{ scale: 1.04 }}
              whileTap={{ scale: 0.96 }}
              className="w-full sm:w-auto px-6 py-3 border border-white/[0.2] text-offwhite font-medium text-sm rounded-[8px] tracking-wide hover:border-amber hover:text-amber transition-colors font-mono text-center justify-center flex items-center"
            >
              Request Access
            </motion.button>
          </div>
        ...
        <div className="lg:col-span-7 relative">
          ...
          >
            {/* Monitor Outer Bezel */}
            <div className="bg-[#0A0A0E] p-2.5 sm:p-3 rounded-2xl border-2 border-amber/20 shadow-monitor-glow">
              {/* Top Camera Dot */}
              ...
              <div className="w-full aspect-video bg-coal rounded-xl overflow-hidden relative">
                {!videoError ? (
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-coal via-slate to-coal p-4 sm:p-6 flex flex-col justify-between">
                    ...
                    <div className="text-center font-display font-extrabold text-2xl sm:text-3xl text-white">
                      LIVE PIT RADAR 04
                    </div>
            ...
            <div className="w-24 sm:w-28 h-5 sm:h-6 bg-[#20202E] mx-auto monitor-stand-base" />
            <div className="w-36 sm:w-44 h-2 bg-[#161622] rounded-full mx-auto" />

            {/* 3 Floating Data Cards around Monitor on Tablets/Desktops */}
            {isInView && (
              <>
                ...
                <motion.div
                  ...
                  className="hidden sm:block absolute -top-4 -left-4 sm:-left-8 bg-coal/90 border border-teal/40 text-teal p-3 rounded-[8px] text-xs font-mono shadow-2xl backdrop-blur-md"
                >
                ...
                <motion.div
                  ...
                  className="hidden sm:block absolute -top-6 -right-4 sm:-right-6 bg-coal/90 border border-amber/40 text-amber p-3 rounded-[8px] text-xs font-mono shadow-2xl backdrop-blur-md"
                >
                ...
                <motion.div
                  ...
                  className="hidden sm:block absolute -bottom-6 -right-2 sm:-right-4 bg-coal/90 border border-red-500/40 text-red-400 p-3 rounded-[8px] text-xs font-mono shadow-2xl backdrop-blur-md"
                >
            ...
            {/* Mobile Stacked Telemetry Badges (Safe, no screen spillover) */}
            <div className="grid grid-cols-1 gap-2 mt-4 sm:hidden">
              <div className="bg-coal/90 border border-teal/40 text-teal p-2.5 rounded-xl text-xs font-mono flex items-center justify-between">
                <span className="text-[10px] text-dim uppercase">SYSTEM RATE</span>
                <span className="font-bold">Compliance: 94%</span>
              </div>
              <div className="bg-coal/90 border border-amber/40 text-amber p-2.5 rounded-xl text-xs font-mono flex items-center justify-between">
                <span className="text-[10px] text-dim uppercase">CONNECTED NODES</span>
                <span className="font-bold">Active Mines: 321</span>
              </div>
              <div className="bg-coal/90 border border-red-500/40 text-red-400 p-2.5 rounded-xl text-xs font-mono flex items-center justify-between">
                <span className="text-[10px] text-dim uppercase">STATUTORY FLAGS</span>
                <span className="font-bold">Alerts: 3 Pending</span>
              </div>
            </div>
          </motion.div>
        </div>
...
function GISMapSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-20 sm:py-32 px-4 sm:px-6 bg-coal relative overflow-hidden"
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        {/* Left Stat Panel */}
        <div className="lg:col-span-5 space-y-6 sm:space-y-8">
          <div>
            ...
            <h2 className="font-display font-extrabold text-3xl sm:text-5xl text-white tracking-tight">
              Sub-Surface Telemetry <br className="hidden sm:inline" />
              <span className="text-amber">Across India.</span>
            </h2>
          </div>

          <div className="grid grid-cols-2 gap-3 sm:gap-6">
            <div className="p-3.5 sm:p-5 bg-graphite rounded-xl sm:rounded-[8px] border border-white/[0.06]">
              <div className="font-display font-extrabold text-3xl sm:text-5xl text-amber">
                <AnimatedCounter value={321} />
              </div>
              <div className="text-[10px] sm:text-xs font-mono text-dim uppercase mt-1">
                Active Mine Sites
              </div>
            </div>
...
function PerspectivesSection() {
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 h-screen w-full flex items-center px-4 sm:px-6 md:px-16 overflow-hidden">
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-4 sm:space-y-6">
            <AnimatePresence mode="wait">
              ...
              >
                <div className="text-[11px] sm:text-xs font-mono text-amber tracking-widest uppercase font-bold">
                  PERSPECTIVE 0{phase} // {current.role}
                </div>

                <h2 className="font-display font-extrabold text-2xl sm:text-4xl lg:text-5xl text-white tracking-tight leading-[1.05]">
                  {current.headline}
                </h2>

                <p className="text-dim text-xs sm:text-base lg:text-lg leading-relaxed font-normal">
                  {current.body}
                </p>

                <div className="space-y-1.5 sm:space-y-2 pt-1 sm:pt-2">
                  {current.features.map((feat) => (
                    <div key={feat} className="flex items-center text-offwhite text-xs sm:text-sm font-medium">
                      <span className="text-amber mr-2.5 sm:mr-3">✓</span>
                      <span>{feat}</span>
                    </div>
                  ))}
                </div>
            ...
            <div className="flex items-center gap-2.5 sm:gap-3 pt-3 sm:pt-6">
              {[1, 2, 3].map((p) => (
                <motion.div
                  key={p}
                  animate={{
            ...
            <AnimatePresence mode="wait">
              {phase === 1 && (
                ...
                <motion.div
                  ...
                  className="w-[230px] sm:w-[280px] h-[360px] sm:h-[460px] md:h-[520px] bg-coal border-4 border-[#222230] rounded-[28px] sm:rounded-[36px] p-3 sm:p-4 shadow-2xl relative flex flex-col justify-between"
                >
                  <div className="w-20 sm:w-24 h-3.5 sm:h-4 bg-[#222230] rounded-full mx-auto mb-3 sm:mb-4" />
                  <div className="space-y-2.5 sm:space-y-3 font-mono text-[11px] sm:text-xs">
                    <div className="p-2.5 sm:p-3 bg-graphite rounded-[8px] border border-amber/20">
                      <div className="text-amber font-bold">FORM 24 VERIFICATION</div>
                      <div className="text-dim text-[9px] sm:text-[10px]">PIT_LOC: SEAM_04_SOUTH</div>
                    </div>
                    <div className="p-2.5 sm:p-3 bg-graphite rounded-[8px] border border-white/[0.06]">
                      <div className="text-offwhite">OFFLINE SYNC: 14 RECORDS PENDING</div>
                    </div>
                    <div className="p-2.5 sm:p-3 bg-graphite rounded-[8px] border border-teal/30 text-teal">
                      <div>GPS ACCURACY: ±0.8 METRES</div>
                    </div>
                  </div>
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-amber/20 border border-amber flex items-center justify-center mx-auto text-amber text-[10px] sm:text-xs font-bold">
                    MIC
                  </div>
                </motion.div>
              )}
              ...
              {phase === 2 && (
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.5 }}
                  className="w-full max-w-sm sm:max-w-md bg-coal border border-white/[0.08] rounded-xl sm:rounded-[8px] p-4 sm:p-6 shadow-2xl space-y-3 sm:space-y-4 font-mono text-xs"
                >
                  <div className="flex justify-between items-center pb-2.5 sm:pb-3 border-b border-white/[0.08]">
                    <span className="text-amber font-bold">EXECUTIVE MINE CONSOLE</span>
                    <span className="text-teal">STATUS: 98.4% SAFE</span>
                  </div>
                  <div className="grid grid-cols-2 gap-2.5 sm:gap-3">
                    <div className="p-2.5 sm:p-3 bg-graphite rounded-[8px]">
                      <div className="text-dim text-[10px] sm:text-xs">METHANE (CH4)</div>
                      <div className="text-white font-bold text-base sm:text-lg">0.04%</div>
                    </div>
                    <div className="p-2.5 sm:p-3 bg-graphite rounded-[8px]">
                      <div className="text-dim text-[10px] sm:text-xs">BENCH STABILITY</div>
                      <div className="text-amber font-bold text-base sm:text-lg">99.8%</div>
                    </div>
                  </div>
                  <div className="p-2.5 sm:p-3 bg-graphite rounded-[8px]">
                    <div className="text-dim mb-1 text-[10px] sm:text-xs">CONTRACTOR SAFETY INDEX</div>
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="relative w-[220px] h-[220px] sm:w-[280px] sm:h-[280px] flex items-center justify-center mb-4 sm:mb-6">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <div className="font-display font-extrabold text-4xl sm:text-6xl text-amber leading-none">
              <AnimatedCounter value={94.3} suffix="%" />
            </div>
          </div>
        </div>

        <div className="text-dim text-xs sm:text-sm uppercase tracking-wider font-mono mb-10 sm:mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 w-full">
          {metrics.map((item, idx) => (
            <motion.div
              ...
              className="bg-graphite border border-amber/10 rounded-xl sm:rounded-[8px] p-4 sm:p-6 text-left"
            >
              <div className="font-display font-extrabold text-2xl sm:text-4xl text-white mb-1.5 sm:mb-2">
                {item.stat}
              </div>
              <div className="text-dim text-xs sm:text-sm font-normal">
                {item.label}
              </div>
            </motion.div>
          ))}
  ...
  return (
    <div className="bg-coal text-offwhite border-t border-white/[0.06]">
      ...
      <section
        id="cta"
        ref={ctaRef}
        className="py-20 sm:py-32 px-4 sm:px-6 flex flex-col items-center text-center relative overflow-hidden"
      >
        {/* Above Headline: 3 Animated Connection Lines */}
        <div className="w-40 sm:w-48 h-10 sm:h-12 mb-4 sm:mb-6">
        ...
        <h2 className="font-display font-extrabold text-3xl sm:text-5xl lg:text-6xl text-white tracking-tight leading-[1.05] max-w-2xl mb-3 sm:mb-4">
          Ready to govern smarter?
        </h2>

        <p className="text-dim text-sm sm:text-lg max-w-md mb-8 sm:mb-10 font-normal">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4 w-full sm:w-auto">
          <motion.button
            ...
            whileHover={{ scale: 1.04 }}
            whileTap={{ scale: 0.96 }}
            className="w-full sm:w-auto px-8 py-4 bg-amber text-coal font-semibold text-sm rounded-[8px] tracking-wide hover:bg-amber/90 transition-colors shadow-[0_0_30px_rgba(245,166,35,0.25)] text-center justify-center flex items-center"
          >
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.04, borderColor: '#F5A623', color: '#F5A623' }}
            whileTap={{ scale: 0.96 }}
            className="w-full sm:w-auto px-8 py-4 border border-offwhite/30 text-offwhite font-medium text-sm rounded-[8px] tracking-wide transition-all text-center justify-center flex items-center"
          >
            Watch Overview ▶
          </motion.button>
        </div>
      ...
      {/* 4-Column Footer */}
      <footer className="border-t border-white/[0.08] pt-12 sm:pt-16 pb-8 sm:pb-12 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 mb-12 sm:mb-16 text-sm">
          {/* Col 1 */}
        ...
        {/* Bottom Bar */}
        <div className="max-w-7xl mx-auto pt-6 sm:pt-8 border-t border-white/[0.06] flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 text-xs font-mono text-dim text-center sm:text-left">
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-3 sm:p-4 bg-black/80 backdrop-blur-md">
      <motion.div
        ...
        className="w-full max-w-lg max-h-[90vh] overflow-y-auto bg-graphite border border-amber/30 rounded-2xl sm:rounded-[8px] p-5 sm:p-8 shadow-2xl relative"
      >
        <button
          onClick={onClose}
...
function VideoModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-3 sm:p-4 bg-black/90 backdrop-blur-lg">
      <motion.div
        initial={{ opacity: 0, scale: 0.95 }}
        animate={{ opacity: 1, scale: 1 }}
        exit={{ opacity: 0, scale: 0.95 }}
        className="w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-graphite border border-amber/30 rounded-2xl sm:rounded-[8px] p-3 sm:p-4 shadow-2xl relative"
      >
        <div className="flex justify-between items-center mb-3 px-1 sm:px-2">
          <div className="text-[11px] sm:text-xs font-mono text-amber truncate pr-2">KHANIJ_AI_PLATFORM_OVERVIEW</div>
          <button
            onClick={onClose}
        ...
        <div className="aspect-video w-full bg-black rounded-xl sm:rounded-[8px] overflow-hidden">
          <video
            src="/dashboard.mp4"
            autoPlay
            controls
...
export default function LandingPageView({ onNavigate, onExplorePlatform, selectedMine, onSelectMine }) {
  ...
  return (
    <div className="min-h-screen bg-coal text-offwhite font-sans antialiased selection:bg-amber selection:text-coal relative overflow-x-clip">
      ...
      <main className="relative z-10">
        ...
        <PerspectivesSection onNavigate={onNavigate} />
